...
public class AlertRuleMapper {
    public static AlertRuleResponse toAlertRuleResponse(AlertRule alertRule){
    ...
    public static List<AlertRuleResponse> toAlertRuleResponses(List<AlertRule> alertRules){
